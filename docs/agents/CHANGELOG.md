...
- The Beginning Zirella reward-room restoration in PR #153 seals UID `50085` until Zirella stage 8, preserves standard open/close door behavior, and remaps shovel/rope tutorials to current reward UIDs `50093/50094` without changing reward contents or the OTBM.
