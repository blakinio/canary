...
| `OTS-20260728-game-catalog-v1` | task `CAN-20260728-game-catalog-export-architecture`; architecture PR pending | task `OTERYN-20260728-versioned-game-catalog-architecture`; architecture PR pending | Offline file contract `oteryn.game-catalog` schema `1.0.0`; byte-identical schema expected at SHA-256 `099a8373ff2b0017cc2b321991662dc4e4783b626391aa7a110a6db0559d146b` | additive producer-first-safe after inactive consumer importer; unsupported schema fails closed | proposed | architecture/schema review pending in both repositories |
