...
| `OTS-20260728-game-catalog-v1` | exporter PR #991; schema 1.1 PR #1006 | Platform importer PR #272; schema 1.1 PR #299 | Offline file contract `oteryn.game-catalog`; schema `1.0.0` SHA-256 `099a8373ff2b0017cc2b321991662dc4e4783b626391aa7a110a6db0559d146b`; schema `1.1.0` SHA-256 `323ff6ae849759c9190f2a0c342855194ed74645816adc45051b6d914e67c7ac` adds an explicitly nullable verified-content boundary | schema 1.1 consumer-first-safe; older consumers fail closed; null-boundary snapshots cannot activate | schema 1.1 merged | Platform #299 merged as `b2b2871eed0375e22d48de5dd4947fe29c2bb974`; Canary #1006 merged as `3ad7155dd833e105cebfd4b472800a4156ac1e90`; schema files are byte-identical and both exact-head validation sets passed |
