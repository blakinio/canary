...
Last reviewed: 2026-07-12T16:30:00+02:00
...
|---:|---|---|---|---|---|
| pending | `feat/otbm-hd-sprite-pipeline` | draft | Region sprite export, AI-upscale preparation/validation, 2x override rendering | `tools/ai-agent/otbm_hd*`, focused tests/docs | Does not modify OTBM or client assets; future OTClient integration remains separate. |
