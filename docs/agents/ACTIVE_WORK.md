...
Last reviewed: 2026-07-12T19:16:00+02:00
...
|---:|---|---|---|---|---|
| draft | `feat/achievement-validation-audit` | active | Deterministic achievement registry and active-trigger validation | `tools/ai-agent/achievement_validation.py`, focused tests, achievement audit docs | Read-only audit first; no registry or gameplay changes. |
