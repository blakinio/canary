...
Last reviewed: 2026-07-12T20:38:00+02:00
...
|---:|---|---|---|---|---|
| [#176](https://github.com/blakinio/canary/pull/176) | `fix/achievement-helper-enumeration` | draft | Sparse-safe achievement helper enumeration and secret lookup | `data/scripts/lib/register_achievements.lua`, focused Lua test, achievement handoff | Stacked on #175; no registry definition, trigger, KV or C++ change. |
