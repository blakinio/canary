...
Last reviewed: 2026-07-12T13:15:00+02:00
...
|---:|---|---|---|---|---|
| draft | `test/analytics-dry-run-audit` | active | Gameplay Analytics no-server/no-database adversarial tests | Analytics correctness edge tests, maintenance config validation, dedicated dry-run workflow | Task: `CAN-20260712-analytics-dry-run-audit`; avoid overlapping Analytics test/harness paths. |
