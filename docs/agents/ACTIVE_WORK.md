...
Last reviewed: 2026-07-12T21:50:00+02:00
...
|---:|---|---|---|---|---|
| [#184](https://github.com/blakinio/canary/pull/184) | `fix/achievement-trigger-names` | draft | Canonical achievement names for two confirmed broken gameplay awards | phantasmal jade Action, Hero of Rathleton reward Action, achievement scanner contract | Stacked on cleanup #182; no registry, KV, storage, reward or C++ change. |
