...
|---:|---|---|---|---|---|
| pending | `fix/raid-startup-waves` | active | Progressive scripted raid spawn waves for upstream #3599 | active Draptor/Yeti encounters, Undead Cavebear identity, focused timing/totals contract | Preserves populations and broadcasts, enforces spawn-before-advance, and removes Draptor's duplicate encounter identity; no framework, map or asset change. |
