...
Last reviewed: 2026-07-12T22:25:00+02:00
...
|---:|---|---|---|---|---|
| [#184](https://github.com/blakinio/canary/pull/184) | `fix/achievement-trigger-names` | ready | Canonical achievement names for two confirmed broken gameplay awards | phantasmal jade Action, Hero of Rathleton reward Action, achievement scanner contract | No registry, KV, storage, reward or C++ change; all focused and full CI gates passed. |
