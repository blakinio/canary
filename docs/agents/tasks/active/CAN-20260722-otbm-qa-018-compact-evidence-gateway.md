...
created: 2026-07-22
updated: 2026-07-22
last_verified_commit: "ad3c673a826db96cea44f1688877e278ea139e8b"
risk: medium
related_issue: ""
related_pr: "741"
depends_on:
...
IMPLEMENTING — bounded exact-source evidence composer is implemented on draft PR #741; current-head validation is running. Subsystem ownership remains with source producers and downstream consumers.
...
head: ad3c673a826db96cea44f1688877e278ea139e8b
branch: feat/otbm-qa-018-compact-evidence-gateway-20260722
pr: 741
status: implementing
context_routes:
...
proven:
  ...
  - Gateway policy explicitly does not parse OTBM, validate source semantics, pathfind, run E2E or own downstream acceptance.
derived:
  - Compact bundles can reduce downstream context without transferring source-contract ownership to the gateway.
unknown:
