...
updated_at: 2026-07-23T16:05:00+02:00
...
changed_paths:
  - docs/agents/tasks/active/CAN-20260723-e2e-qri-002-canary-restart-recovery.md
validation:
  - command: live GitHub preflight against current main and open PR inventory
    result: PASS
    evidence: Main, QRI-003 ownership, programme, roadmap, module catalogue, lifecycle runner, recovery scenario and workflow were inspected before shared ownership was used.
blockers: []
next_action: Publish the refreshed draft PR, implement the minimal manifest guard plus runner-owned restart seam and client recovery synchronization, then run focused and physical GitHub Actions validation.
```
