...
proven:
  ...
  - No open E2E-QRI pull request or active QRI-004 owner was found during the fresh handover preflight.
derived:
...
validation:
  ...
  - command: live open-PR and ownership search
    result: PASS
    evidence: No open E2E-QRI PR or active QRI-004 owner was found.
  - command: python tools/agents/checkpoint.py docs/agents/tasks/active/CAN-20260724-e2e-qri-004-coverage-dashboard.md --require-checkpoint
    result: NOT_RUN
    evidence: Run after the PR identity is recorded in the final compact checkpoint.
blockers: []
