...
branch: fix/the-beginning-zirella-door-rewards-clean
base_branch: main
created: 2026-07-12
updated: 2026-07-12
risk: medium
...
- The generic quest reward table maps tutorial `10` to UID `50093` and tutorial `11` to UID `50094`.
- No reward item, capacity handling, storage ownership, AID registration, or NPC state is changed.
