...
updated: 2026-07-16T18:29:36+02:00
...
reuses:
  - existing GameplayAnalytics core table
...
updated_at: 2026-07-16T18:29:36+02:00
...
conflicts: []
blockers: []
next_action: Implement idempotent core loading and extension self-bootstrap, add focused regression validation, then open and validate a narrow repair PR.
```
