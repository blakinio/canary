...
The final lifecycle PR owns only the active-to-archive task transition represented by this record; it does not modify the durable program ledger or target task lifecycle.
