...
|---|---|---|---|---|
| UI-001 | Read-only source registry, schemas, scanner, reports, workflow and policies | active | task `CAN-20260714-upstream-intelligence-drift-tracking` | complete PR, full CI, merge and archive |
| UI-002 | First production scan and report-issue verification | blocked-by-UI-001 | merge of UI-001 | verify the post-merge workflow run and report issue |
| UI-003 | Reviewed candidate bootstrap | planned | first deep snapshot | triage only high/urgent candidates into pinned decisions |
...
`CAN-20260714-upstream-intelligence-drift-tracking`, PR #331.
