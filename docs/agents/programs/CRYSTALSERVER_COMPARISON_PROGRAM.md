...
|---|---|---|---|
| `CAN-20260714-fs-mkdir-shell-injection` / [#310](https://github.com/blakinio/canary/pull/317) | `CS-006` | active | Replace Lua shell-based directory creation with native `std::filesystem` operations and focused Lua/C++ regressions. |
...
| `CS-006` | `891685169745e46f665069edcc35847f0704aa21` | `VALID_FIX_MISSING` | high | `FS.mkdir` shell construction | Active in task `CAN-20260714-fs-mkdir-shell-injection` / PR #317; preserve API behavior while removing all shell execution. |
