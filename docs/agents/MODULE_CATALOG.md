...
| Cyclopedia validation audit | ready (#170) | Read-only validation of Items, Bestiary, Charms, Bosstiary, Map, Character/Titles, Houses and Canary ↔ maintained OTClient protocol surfaces | `tools/ai-agent/cyclopedia_validation.py`, focused tests, dedicated workflow, `docs/ai-agent/OTS_AI_CYCLOPEDIA_VALIDATION_PROJECT.md` | Reuse for Cyclopedia drift and regression checks; keep gameplay/data fixes in focused PRs and never invent replacement IDs. |
