...
class UpstreamIntelligenceSocialTests(unittest.TestCase):
    @classmethod
    ...
    def test_server_source_maps_social_boundaries(self) -> None:
        row = self.candidate([
        ...
        for expected in ("chat-communication", "guilds", "parties", "sanctions"):
    ...
    def test_client_source_preserves_protocol_without_server_social_modules(self) -> None:
        row = self.candidate([
            "src/creatures/interactions/chat.cpp",
            "src/creatures/players/grouping/party.cpp",
            "src/creatures/players/grouping/guild.cpp",
        ...
        for invalid in ("chat-communication", "guilds", "parties", "sanctions"):
