...
if "ForgeFailedFusionHistoryUsesRecordedDustCost" in text:
    raise RuntimeError("Forge history integration tests already exist")
...
'''
integration.write_text(text.rstrip("\n") + append.rstrip() + "\n", encoding="utf-8")
