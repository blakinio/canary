...
assert_scalar "primary aggregate shared seconds" "SELECT shared_experience_seconds FROM analytics_daily_balance WHERE server_version='retention-build' AND hunt_area='retention-area' AND vocation_id=1 AND level_bracket=500" "100"
